 ...
 * 地支实体
 */
export class DiZhiEntity {
    private static property: { [key: string]: string } = {
        '子': '水',
        '丑': '土',
        '寅': '木',
        '卯': '木',
     ...
     * @return string | false
     */
    public static getPropertyByDiZhi(diZhi: string): string | false {
        return this.property[diZhi] || false;
    }

    private static strength: { [key: string]: { [key: string]: { [key: string]: number } } } = {
        '子': {
        ...
        '申': {
            '壬': {
                '子': 0.36, '丑': 0.33, '寅': 0.30, '卯': 0.30, '辰': 0.312, '巳': 0.318, '午': 0.30, '未': 0.30, '申': 0.36, '酉': 0.36, '戌': 0.318, '亥': 0.342
            },
            '庚': {
                '子': 0.70, '丑': 0.798, '寅': 0.70, '卯': 0.70,
                '辰': 0.77, '巳': 0.742, '午': 0.70, '未': 0.77,
                '申': 0.798, '酉': 0.84, '戌': 0.812, '亥': 0.70
            },
        },
        '酉': {
            '辛': {
                '子': 1.00, '丑': 1.14, '寅': 1.00, '卯': 1.00,
                '辰': 1.10, '巳': 1.06, '午': 1.00, '未': 1.10,
                '申': 1.14, '酉': 1.20, '戌': 1.16, '亥': 1.00
            },
        },
        '戌': {
            '辛': {
                '子': 0.30, '丑': 0.342, '寅': 0.30, '卯': 0.30,
                '辰': 0.33, '巳': 0.318, '午': 0.30, '未': 0.33,
                '申': 0.342, '酉': 0.36, '戌': 0.348, '亥': 0.30
            },
            '丁': {
                '子': 0.20, '丑': 0.20, '寅': 0.24, '卯': 0.24,
                '辰': 0.212, '巳': 0.228, '午': 0.24, '未': 0.22,
                '申': 0.20, '酉': 0.20, '戌': 0.208, '亥': 0.212
            },
            '戊': {
                '子': 0.50, '丑': 0.55, '寅': 0.53, '卯': 0.50,
                '辰': 0.55, '巳': 0.57, '午': 0.60, '未': 0.58,
                '申': 0.50, '酉': 0.50, '戌': 0.57, '亥': 0.50
            },
        },
        '亥': {
            '甲': {
                '子': 0.36, '丑': 0.318, '寅': 0.342, '卯': 0.36,
                '辰': 0.33, '巳': 0.30, '午': 0.30, '未': 0.312,
                '申': 0.318, '酉': 0.30, '戌': 0.30, '亥': 0.36
            },
            '壬': {
                '子': 0.84, '丑': 0.77, '寅': 0.70, '卯': 0.70,
                '辰': 0.728, '巳': 0.742, '午': 0.70, '未': 0.70,
                '申': 0.84, '酉': 0.84, '戌': 0.724, '亥': 0.798
            },
        },
    };
     ...
     * @param diZhi
     * @param monthDizhi
     * @return { [key: string]: number } | false
     */
    public static getStrengthByDiZhiAndMonth(diZhi: string, monthDizhi: string): { [key: string]: number } | false {
        const cangs = this.strength[diZhi];
        if (cangs) {
            const data: { [key: string]: number } = {};
            for (const key in cangs) {
                data[key] = cangs[key][monthDizhi] || 0;
            }
            return data;
        } else {
            return false;
