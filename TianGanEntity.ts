...
export class TianGanEntity {
     ...
     * @return string | false
     */
    public static getPropertyByTianGan(tianGan: string): string | false {
        return this.property[tianGan] || false;
    }

    private static strength: { [key: string]: { [key: string]: number } } = {
     ...
     * @return number | false
     */
    public static getStrengthByTianGanAndMonth(tianGan: string, monthDizhi: string): number | false {
        return this.strength[tianGan]?.[monthDizhi] || false;
    }
}